...
pl.idle = function(e)
  ...
  if btnp(5) and e.jump_cd==0 then e.state="jump" e.timer=0 e.jvy=-3.5 end
end
...
pl.draw = function(e)
  local sc=e.hp<=1 and 2 or (e.hp<=2 and 8 or 7)
  if e.state=="slip" then
    local t=e.slip_type or 0
    local hd=t==1 and -e.dir or e.dir
    rectfill(e.x-9,e.y-4,e.x+9,e.y,sc)
    circfill(e.x+hd*8,e.y-5,3,9)
    return
  end
  local jo=e.jsy or 0

  local x=e.x-4  local y=e.y-15+jo
  local fr=(e.state=="walk" and flr(time()*8)%2) or 0
  rectfill(e.x-3,e.y-1+jo,e.x+3,e.y+jo,5)
  rectfill(x+1,y+fr,x+6,y+fr+5,9)
  rectfill(x,y+fr+6,x+7,y+fr+11,sc)
  if e.hp>2 then
    local ssx={2,5,1,4,6}  local ssy={1,3,4,2,1}
    for i=1,5-e.hp do
      pset(x+ssx[i],y+fr+6+ssy[i],8)
      pset(x+ssx[i]+1,y+fr+6+ssy[i],8)
      pset(x+ssx[i],y+fr+6+ssy[i]+1,8)
    end
  end
  if fr==0 then
    rectfill(x-1,y+12,x+2,y+15,4)
    rectfill(x+5,y+12,x+8,y+15,4)
  else
    rectfill(x+1,y+12,x+3,y+15,4)
    rectfill(x+4,y+12,x+6,y+15,4)
  end
end
...
function npc_draw(e)
  ...
  rectfill(x+1,y+fr,x+6,y+fr+5,flash and 7 or 9)
  rectfill(x,y+fr+6,x+7,y+fr+11,flash and 7 or 8)
  if fr==0 then
    rectfill(x-1,y+12,x+2,y+15,4)
    rectfill(x+5,y+12,x+8,y+15,4)
  else
...
__gfx__

